...
const FloatingWhatsApp = () => (
  ...
  >
    ...
    <motion.div
      ...
      className="absolute right-full mr-4 top-1/2 -translate-y-1/2 glass-card px-4 py-2.5 rounded-xl whitespace-nowrap pointer-events-none"
    >
      <p className="text-[12px] font-body font-semibold text-foreground tracking-wide">
        Agendar Reunião
      </p>
    </motion.div>

    {/* Botão */}
    <div className="relative w-[60px] h-[60px] bg-primary rounded-full flex items-center justify-center shadow-[0_8px_28px_rgba(43,65,42,0.35)] group-hover:shadow-[0_14px_42px_rgba(43,65,42,0.45)] transition-shadow duration-400">
      {/* WhatsApp SVG */}
      <svg
